...
# Kinneret #
phyto.kin.fuzFDs.mth <-tidyFD(speciesdat =  plank_env.data.mth[,4:48], traitdat =  phyto.kin.traits.dat, trophic.lvl = "phyto",
                              approach = "mFD",ndim=8,
...
# Windermere #
phyto.wind.fuzFDs.mth <-tidyFD(speciesdat =  phyto_env.windmthdata[,4:20], phyto.wind.traits.dat, trophic.lvl = "phyto",
                               approach = "mFD",ndim=5,
                               traittype = "fuzzy", method = FD_metrics, correction="cailliez")
...
zoo.wind.fuzFDs.yr <-tidyFD(phyto_env.windyrdata[,20:23], zoo.wind.traits.dat, trophic.lvl = "zoo",
                           approach = "mFD",ndim=10,
                           traittype = "fuzzy", method = FD_metrics, correction="cailliez")
zoo.wind.fuzFDs.yr <- cbind(date = as.numeric(phyto_env.windyrdata$Date),zoo.wind.fuzFDs.yr)
write.csv(zoo.wind.fuzFDs.yr,file = "Data/raw_FD/FD_wind_zoo_yr_raw.csv",row.names = F)
